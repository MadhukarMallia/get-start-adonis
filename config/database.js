...
module.exports = {
  ...
  */
  ...
  |--------------------------------------------------------------------------
  |
  |   Below is configuration for PostgreSQL database, if your application is
  |   dependent upon PostgreSQL , define your credentials inside .env file,
  |   as it is a good practice to keep environment configuration
  |   isolated for each environment.
  |
  |--------------------------------------------------------------------------
  ...
  */
  postgresql: {
    ...
    connection: {
      ...
      user: Env.get('POSTGRESQL_USER', 'postgres'),
      password: Env.get('POSTGRESQL_PASSWORD', 'password'),
      database: Env.get('POSTGRESQL_DATABASE', 'adonis')
    }
  }
/*
|--------------------------------------------------------------------------
